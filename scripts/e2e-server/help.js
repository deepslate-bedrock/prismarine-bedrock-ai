...
function printHelp() {
  console.log([
    ...
    "  E2E_EXIT_AFTER_SCENARIO       Set 0 to keep scenario servers running after completed scenario_end",
    "  E2E_SCENARIO_PROGRESS_INTERVAL_MS  Progress heartbeat interval while a scenario is running, default 30000",
    ...
    "  --no-exit-after-scenario Keep Endstone scenario servers running after completed scenario_end",
    "  --scenario-progress-interval-ms=N Progress heartbeat interval while a scenario is running, default 30000",
